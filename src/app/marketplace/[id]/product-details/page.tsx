      ...
      <main className="max-w-7xl mx-auto px-8 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button 
              onClick={() => router.push(`/marketplace/${id}/webpage`)}
              className="px-8 bg-white border border-stone-200 text-stone-900 py-6 rounded-2xl font-sans text-xs font-bold uppercase tracking-widest hover:bg-stone-50 transition-all shadow-sm"
            >
              Visit Store
            </button>
          </div>
