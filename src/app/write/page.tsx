          ...
          {isLoaded && user ? (
            <>
              <button 
                ...
                disabled={isSaving} 
                className="text-xs font-sans font-bold uppercase tracking-widest text-stone-400 hover:text-stone-900"
              >
              ...
              <button 
                ...
                disabled={isSaving} 
                className="bg-stone-900 text-white px-6 py-2 rounded-full font-sans text-xs font-bold hover:bg-orange-700 transition-all"
              >
